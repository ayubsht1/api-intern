...
SECRET_KEY = 'django-insecure-ma&q=qi6duba-7lr24(*l8jc)6i!v64(3glymy2zrm1^(qu!1l'
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("authentication.authenticate.JWTAuthentication",)
}
